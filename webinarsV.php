...
<style type="text/css">
  ...
  <header id="header" class="d-flex align-items-center">
    <div class="container d-flex justify-content-between align-items-center">
      ...
      <div class="logo">
        <h1><a href="webinarsV.php">Webinars</a></h1>
      </div>
  ...
  <main id="main">
    ...
    <!-- ======= Featured Section ======= -->
    <?php
    $sel = $con->query("SELECT * FROM webinars");
    ?>
            ...
            <div class="col-lg-4">
              <div class="card" style="width:  25rem;">
                <div class="icon-box">
                  ...
                  if ($row['pdf'] != NULL) {
                  ?>
                    <a style="padding-right: 240px" onclick="openModalWbn('<?php echo $row['pdf'] ?>')"  type="button" title="Ver PDF"><i class='bx bxs-file-pdf'></i></a>
                  <?php
                  }
                  ?>
                  <?php
                  if ($row['img'] != NULL) {
                  ?>
                    <a onclick="openModalWbnI('<?php echo $row['img'] ?>')"  type="button" title="Ver Imagen"><i class='bx bxs-file-image'></i></a>
                  <?php
                  }
                  ?>
                  <center>
                    <h3><a><?php echo $row['titulo'] ?></a></h3>
                    <h6><?php echo $row['subtitulo'] ?></h6>
                    <p align="justify"><?php echo $row['resumen'] ?></p>
                    <br />
                    <p style="padding-left">Autor: <?php echo $row['autor_wbns'] ?> Fecha: <?php echo $row['fecha'] ?> Hora: <?php echo $row['hora'] ?></p>
